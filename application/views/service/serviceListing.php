        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>addService"><i class="fa fa-plus"></i> Add Services</a>
                </div>
            </div>
        </div>
        <div class="row">
              ...
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    ?>
                    <tr>
                        <td><img src="<?= base_url(); ?>uploads/<?=$record->service_image; ?>" width="100px"></td>
                        <td><?php echo $record->service_name ?></td>
                        <td><?php echo $record->p_service_name ?></td>
                        <td class="text-center">
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'editService/'.$record->service_id; ?>" title="Edit"><i class="fa fa-pencil"></i></a> |
                            <a class="btn btn-sm btn-danger" href="<?php echo base_url().'servicedelete/'.$record->service_id; ?>" onclick="return prod_del();" title="Delete"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                        }
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "index.php/serviceListing/" + value);
