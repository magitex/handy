    ...
    <div id="side-panel" class="side-panel">
        ...
        <div id="content" class="site-content">
            <div class="page-header dtable text-center header-transparent">
                <div class="dcell">
                    <div class="container">
                        <h1 class="page-title">Historic Research</h1>
                        <!-- <ul id="breadcrumbs" class="breadcrumbs none-style">
                            <li><a href="<?php echo base_url(); ?>home">Home</a></li>
                            <li class="active">Historic Research</li>
                        </ul> -->    
                    </div>
                </div>
            </div>
        ...
        <div class="entry-content">
            <div class="container">
                <div class="row pb-50">
                            <div class="col-lg-8 col-md-12 mb-4 mb-lg-0">
                                <div class="ot-heading is-dots">
                                    <span>&nbsp;</span>
                                    <h2 class="main-heading">Historic Research</h2>
                                </div>
                            </div>
                ...
                <div class="row justify-content-center">
                            <?php foreach($historic as $record) { ?>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="post-box masonry-post post-item">
                                    <div class="post-inner">
                                        <div class="entry-media post-cat-abs">
                                            <a href="<?php echo base_url(); ?>historic_research_details/<?php echo $record->historic_id ?>"><img src="<?php echo assets_url(); ?>historic_uploads/<?php echo $record->historic_image; ?>" alt="" /></a>
                                            <div class="post-cat">
                                                <!-- <div class="posted-in"><a href="<?php echo base_url(); ?>historic_research_details/<?php echo $record->historic_id ?>">Caucasus Heritage</a></div> -->
                                            </div>
                                        </div>
                                        <div class="inner-post">
                                            <div class="entry-header">
                                                <div class="entry-meta">
                                                    <span class="posted-on"><a href="<?php echo base_url(); ?>historic_research_details/<?php echo $record->historic_id ?>"><?php echo date("M d, Y", strtotime($record->created_dtm)) ?></a></span>
                                                    <span class="byline">
                                                        <span class="author vcard"><a class="url fn n" href="#">&nbsp;</a></span>
                                                    </span>
                                                </div>
                                                <!-- .entry-meta -->

                                                <h5 class="entry-title">
                                                    <a class="title-link" href="<?php echo base_url(); ?>historic_research_details/<?php echo $record->historic_id ?>"><?php echo $record->historic_title ?></a>
                                                </h5>
                                            </div>
                                            <!-- .entry-header -->
