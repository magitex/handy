                ...
                <div class="dcell">
                    <div class="container">
                        ...
                        <!-- <ul id="breadcrumbs" class="breadcrumbs none-style">
                            ...
                            <li class="active">Research Details</li>
                        </ul> -->    
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <!-- <div class="content-area col-lg-12 col-md-12 col-sm-12 col-xs-12"> -->
                            <div class="content-area content-page">
                                <img src="<?php echo assets_url(); ?>historic_uploads/<?php echo $historicInfo->historic_image; ?>" alt="">
                            <!-- <article class="post-box"> -->
                                <!-- <div class="post-inner"> -->
                                    <!-- <div class="inner-post"> -->
                                        <div class="entry-header">
                                            <h4 class="entry-title"><a class="title-link"><?php echo $historicInfo->historic_title ?></a></h4>
                                            <div class="entry-meta">
                                                <span class="posted-on"><?php echo date("M d, Y", strtotime($historicInfo->created_dtm)) ?></span>                                          
                                            </div>
                                        </div>
                                        <div class="entry-summary the-excerpt">
                                            <p><?php echo $historicInfo->historic_description ?></p>
                                        </div>
