                        ...
                        <!-- <article class="post-box"> -->
                            <!-- <div class="post-inner"> -->
                                <!-- <div class="entry-media post-cat-abs"> -->
                                    <!-- <img src="<?php echo assets_url(); ?>news_uploads/<?php echo $newsInfo->news_image; ?>" alt=""> -->
                                    <!-- <div class="post-cat">
                            ...
                            <img src="<?php echo assets_url(); ?>news_uploads/<?php echo $newsInfo->news_image; ?>" alt="">   
                                    <div class="entry-header">
                                        <div class="entry-meta">
                                            <span class="posted-on"><?php echo date("M d, Y", strtotime($newsInfo->created_dtm)) ?></span>                                            
                                        </div>
                                        <h4 class="entry-title"><a class="title-link"><?php echo $newsInfo->news_title ?></a></h4>
                                    </div>
