        ...
        <div class="entry-content">
            <div class="container">
                <div class="row pb-50">
                            <div class="col-lg-8 col-md-12 mb-4 mb-lg-0">
                                <div class="ot-heading is-dots">
                                    <span>&nbsp;</span>
                                    <h2 class="main-heading">Our Partners</h2>
                                </div>
                            </div>
                ...
                <div class="row justify-content-center">
                            <?php foreach($partners as $record) { ?>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="post-box masonry-post post-item">
                                    <div class="post-inner">
                                        <div class="entry-media post-cat-abs">
                                            <a><img src="<?php echo assets_url(); ?>partners_uploads/<?php echo $record->partners_image; ?>" alt="" /></a>
                                            <div class="post-cat">
                                        ...
                                        <div class="inner-post">
                                            <div class="entry-header">
                                                ...
                                                <h5 class="entry-title">
                                                    <a href="<?php echo $record->partners_link; ?>" class="title-link" target="_blank"><?php echo $record->partners_name ?></a>
                                                </h5>
                                            </div>
                                            <!-- .entry-header -->
