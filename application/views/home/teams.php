                                    ...
                                    <div class="post-inner">
                                        <div class="entry-media post-cat-abs">
                                            <?php 
                                                ...
                                                if ($ping == ""){ ?>
                                                    <a><img src="<?php echo assets_url(); ?>assets/dist/img/image.png" alt="" /></a>
                                                <?php
                                                }
                                                else{ ?>
                                                    <a><img src="<?php echo assets_url(); ?>team_uploads/<?php echo $ping; ?>" alt="" /></a>
                                                <?php
                                                    }
                                                ?>
                                            <div class="post-cat">
                                        ...
                                        <div class="inner-post">
                                            <div class="entry-header">
                                                ...
                                                <h5 class="entry-title">
                                                    <a class="title-link"><?php echo $record->team_name ?></a>
                                                </h5>
                                            </div>
                                            <!-- .entry-header -->
